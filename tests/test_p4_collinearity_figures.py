...
def test_p4_collinearity_outputs_match_expected_degree_sequences(tmp_path: Path) -> None:
    ...
    certificate = pd.read_csv(asset_root / "data" / "processed" / "p4_collinearity_certificate.csv")
