...
class AcquisitionStatus(str, Enum):
    ...
    COMPLETE_NATIVE_SOURCE = "COMPLETE_NATIVE_SOURCE"
    COMPLETE_REMOTE = "COMPLETE_REMOTE"
    COMPLETE_REMOTE_NATIVE_LAZY = "COMPLETE_REMOTE_NATIVE_LAZY"
...
class RedistributionStatus(str, Enum):
    ...
    PUBLISHER_SUPPLEMENTAL_SOURCE = "publisher_supplemental_source"
    CC_BY_4_0_ARTICLE_SUPPLEMENT = "CC_BY_4_0_article_supplement"
